...
- [4. Fan-out (scatter/gather)](4_fan-out.md) — parallel branches (pools and lanes): `Schedule` rounds and follow-ups with `Wait`, ordering guarantees, `Detach()` and `Wave.Wait`
